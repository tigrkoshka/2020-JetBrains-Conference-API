...
_tap2.default.test('GET \'/find_*field_name*/\' route', function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            t.same(res.json(), _compareData.findFieldData);
...
_tap2.default.test('GET \'/find_*field_name*/except/\' route', function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 13:
            ...
            t.same(res.json(), _compareData.findFieldExceptData);
...
_tap2.default.test('GET \'/find_*field_name*/only/\' route', function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 13:
            ...
            t.same(res.json(), _compareData.findFieldOnlyData);
