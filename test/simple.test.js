...
_tap2.default.test('GET \'/\' route', function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            t.same(res.json(), _compareData.allData);
...
_tap2.default.test('GET \'/except/\' route', function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            t.same(res.json(), _compareData.exceptOneData);
          ...
          case 13:
            ...
            t.same(res.json(), _compareData.exceptManyData);
...
_tap2.default.test('GET \'/only/\' route', function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 9:
            ...
            t.same(res.json(), _compareData.onlyOneData);
          ...
          case 13:
            ...
            t.same(res.json(), _compareData.onlyManyData);
